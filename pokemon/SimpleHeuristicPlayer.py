# https://github.com/attraylor/poke-env/blob/master/examples/BigBoy_refactor/players/SimpleHeuristicPlusPlayer.py
...
class SimpleHeuristicPlayer(RandomEnvPlayer):

    def __init__(self, name, team, battle_format="gen8ou", log_level = 0, server_configuration=None, save_replays=False):
        super().__init__(team=team, name=name, battle_format=battle_format, log_level = log_level, server_configuration=server_configuration, save_replays=save_replays)
        self.name = name
